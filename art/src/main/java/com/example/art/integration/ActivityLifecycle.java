...
import com.example.art.base.delegate.ActivityDelegate;
import com.example.art.base.delegate.ActivityDelegateImpl;
import com.example.art.base.delegate.FragmentDelegate;
import com.example.art.base.delegate.FragmentDelegateImpl;
...
public class ActivityLifecycle implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
        ...
        // 默认为false,如果不需要管理(比如不需要在退出所有activity(killAll)时，
        // 退出此activity就在intent加此字段为true)
        ...
        if (activity instanceof FragmentActivity && useFragment) {
            ...
            ((FragmentActivity) activity).getSupportFragmentManager().registerFragmentLifecycleCallbacks(mFragmentLifecycle, true);//activity 注册生命周期
            ...
            if (mFragmentLifecycles == null) {
                ...
                for (ConfigModule module : modules) {
                    module.injectFragmentLifecycle(mApplication, mFragmentLifecycles);// fragment 注册生命周期
...
//            if (f instanceof Onlaze) {
//                ((IFragment) f).lazyLoadAftFragmentViewCreated();
//            }
        }
