...
public class ManifestParser {
    ...
    private static ConfigModule parseModule(String className) {
        ...
        if (!(moduls instanceof ConfigModule)){
            throw new RuntimeException("Expected instanceof ConfigModule, but fount : " + moduls ) ;
        }

        return ((ConfigModule) moduls);
