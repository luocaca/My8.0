...
//                        HttpUrl.Builder builder1 = oldRequest.url()
//                                .newBuilder()
...
//                                .addQueryParameter("version", "3.0.4")
//                                .addQueryParameter("deviceId", "deviceId")
//                                .addQueryParameter("type", "type")
//                                .addQueryParameter("sdkVersion", "6.0")
//                                .addQueryParameter("deviceType", "android")
//                                .addQueryParameter("manufacturer", "honor");
//
                    ...
                    public Request onHttpRequestBefore(Interceptor.Chain chain, Request request) {
                         /* 如果需要再请求服务器之前做一些操作,则重新返回一个做过操作的的requeat如增加header,不做操作则直接返回request参数
                           return chain.request().newBuilder().header("token", tokenId)
                                  .build(); */
//                        HttpUrl.Builder builder1 = request.url()
//                                .newBuilder()
